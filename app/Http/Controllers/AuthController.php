    ...
    public function login(LoginRequest $request)
{
    ...
    {
        $user = User::query()->where('user_type', UserRoles::CLIENT)->firstWhere('phone', $request->input('phone'));
    ...
    public function updateProfile(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('profile_picture')) {
                ...
                $imagePath = $image->store('profile_pictures', 'public');  // Store in public disk
